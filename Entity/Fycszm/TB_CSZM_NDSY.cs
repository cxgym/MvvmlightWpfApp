namespace MvvmlightWpfApp.Entity.Fycszm
{
    ...
    public partial class TB_CSZM_NDSY
    {
        [StringLength(64)]
        ...
        public long? SLQKCS { get; set; }

        public long? CSZMSLS { get; set; }

        public long? CSSQS { get; set; }
        ...
        public long? DNNDKCS { get; set; }

        public long? DNBJGHCS { get; set; }

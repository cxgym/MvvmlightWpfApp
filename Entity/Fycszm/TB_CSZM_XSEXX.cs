namespace MvvmlightWpfApp.Entity.Fycszm
{
    ...
    public partial class TB_CSZM_XSEXX
    {
        [Key]
        [StringLength(64)]
        public string XSE_ID { get; set; }
        ...
        [StringLength(12)]
        public string MQ_HJDZSHI { get; set; }

        [StringLength(12)]
        public string MQ_HJDZXIAN { get; set; }

        [StringLength(200)]
        public string MQ_YBHJDZ { get; set; }

        [StringLength(200)]
        public string MQ_SFZDZ { get; set; }

        [StringLength(12)]
        public string MQ_JZDZSHEN { get; set; }

        [StringLength(12)]
        public string MQ_JZDZSHI { get; set; }

        [StringLength(12)]
        public string MQ_JZDZXIAN { get; set; }

        [StringLength(200)]
        public string MQ_YBJZDZ { get; set; }
        ...
        [StringLength(12)]
        public string FQ_HJDZSHEN { get; set; }

        [StringLength(12)]
        public string FQ_HJDZSHI { get; set; }

        [StringLength(12)]
        public string FQ_HJDZXIAN { get; set; }

        [StringLength(200)]
        public string FQ_YBHJDZ { get; set; }

        [StringLength(200)]
        public string FQ_SFZDZ { get; set; }
        ...
        [StringLength(11)]
        public string DJJGCODE { get; set; }
        ...
        [StringLength(2)]
        public string SQXGZT { get; set; }

        [StringLength(64)]
        public string SQXGLSH { get; set; }

        [StringLength(64)]
        public string BFDJLSH { get; set; }
        ...
        [StringLength(12)]
        public string MQ_HJDZSHEN { get; set; }

namespace MvvmlightWpfApp.Entity.Fycszm
{
    ...
    public partial class TB_CSZM_BFDJ
    {
        [StringLength(64)]
        ...
        [StringLength(11)]
        public string SQJGCODE { get; set; }
        ...
        [StringLength(2)]
        public string BFDJDYZT { get; set; }

        public DateTime? BFDJDDYRQ { get; set; }

        [StringLength(2)]
        public string CSZMDYZT { get; set; }

        public DateTime? CSZMDYRQ { get; set; }
        ...
        [StringLength(11)]
        public string TY_DJJGCODE { get; set; }

        [StringLength(100)]
        public string TY_DJJGMC { get; set; }

        public DateTime? BFDJRQ { get; set; }
